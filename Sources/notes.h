...
static const char * const OHKillDnote = "Makes destructables, such as cactus, one hit kill.";
...
static const char * const slabsnote = "Gives you x99 of every Slab.";
static const char * const healitemnote = "Gives you x99 of every Healing Item.";
static const char * const weaponnote = "Gives you every Weapon.";
