...
def all_folder_file(pattern, ext):
    s = ""
...
EUR_TID = "00040000001A4900"
USA_TID = "00040000001A4800"
...
CFLAGS = ' -Os -c ' + ARCH
ASFLAGS = ' -Os -c -s ' + ARCH
LIBFLAGS = " -lg -lsysbase -lntr -lShark2NTR_dev-mod -lctr -lc -lgcc "
LDFLAGS = ' -pie --gc-sections -T 3ds.ld -Map=' + NAME + '.map '
INCLUDES = " -I Includes -I Sources -I Includes/libntrplg "
CFILES = all_folder_file(".\\Sources\\", ".c")
ASFILES = all_folder_file(".\\Sources\\", ".s")
OFILES = all_folder_file(".\\ofiles\\", ".o")
ftp = FTP()
FILE = COPYTOPATH
...
OFILES += all_file("*.o") + " " + all_file("lib/*.o")
